window.onload = function() {
	...
	const school = document.getElementById("highlight1");
	const transcript = document.getElementById("transcript");
	const transcriptSpan = transcript.getElementsByTagName("span");
...
/*	function updateTime() {
	...
	*/
	...
	/*function hStart(startID) {
		const highlight = document.getElementById(startID).classList;
		highlight.add('highlight');
	}

	function hEnd(endID) {
		const highlight = document.getElementById(endID).classList;
...
/*	function startHighlight(startID) {
	  var highlight = document.getElementByClassName('test');
	  highlight.className('highlight');
	}

	function endHighlight(endID) {
	  var highlight = document.getElementByClassName('p-container').classList;
	  highlight.className('');
	}*/
